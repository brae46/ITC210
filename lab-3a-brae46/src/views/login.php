...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <article>
        <h2 id=tasktitle >Log Into Account</h2>
      </article>
      <br>
      ...
      <div>
        <form action="../actions/login_action.php" method="post">
          ...
          <button id=taskbutton type="submit" class="btn btn-primary">Log In</button>
        </form>
          <br>
        <form action="../views/register.php" method="post"> <!--button doesnt do anything -->
          <button id=registerButton type="submit" class="btn btn-primary">Register Here</button>
        </form>
        <?php
