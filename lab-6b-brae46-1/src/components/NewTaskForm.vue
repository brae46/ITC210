      ...
      <v-container>
        <v-row>
          ...
          <v-col cols="12" xs="12" sm="6">
            ...
            <v-text-field label="Add a task..." prepend-icon="edit" v-model="form.Text" required></v-text-field>
          ...
          <v-col cols="12" xs="12" sm="4">
            <v-menu v-model="menu" :close-on-content-click="false" :nudge-right="40" transition="scale-transition" offset-y min-width="290px">
              <template v-slot:activator="{ on }">
                ...
                <v-text-field label="When should the task be done?" prepend-icon="event" v-model ="form.Date" v-on="on"></v-text-field>
