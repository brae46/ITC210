...
class TestAPI(unittest.TestCase):
    ...
    # base_url, cookie = "http://s2.it210.it.et.byu.edu", "s%3Adq..." # For s2
    # base_url, cookie = "http://s3.it210.it.et.byu.edu", "s%3A-t..." # For s3
    # base_url, cookie = "http://s4.it210.it.et.byu.edu", "s%3AJi..." # For s4
    base_url, cookie = "http://nodejs-brae46.it210.it.et.byu.edu/", "s%3AtNcuU9atnzBZbufIKkk4vyXW_Gwb0oGg.l2milp7hYMS%2B5uQpOc9MaBfyTRYnbyCyJJccaDzSUdE" 
    # base_url, cookie = "http://localhost:1337/:id", "s%3AJi..."
